...
public class EditDelfoiBulletinPageController extends DelfoiPageController {

  public EditDelfoiBulletinPageController() {
    super();
  ...
  public void processPageRequest(PageRequestContext pageRequestContext) {
    ...
    pageRequestContext.setIncludeJSP("/jsp/pages/admin/editbulletin.jsp");
  }
