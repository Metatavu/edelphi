...
public class ManagePanelBulletinsPageController extends PanelPageController {

  public ManagePanelBulletinsPageController() {
    super();    
  ...
  public void processPageRequest(PageRequestContext pageRequestContext) {
    ...
    pageRequestContext.setIncludeJSP("/jsp/pages/panel/admin/managepanelbulletins.jsp");
  }
}