...
<html>
  <head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/_scripts/gui/admin/importgdocsblockcontroller.js"></script>
  </head>
    ...
    <div class="GUI_pageWrapper">
      ...
      <div class="GUI_pageContainer">
        ...
        <div class="GUI_adminManageMaterialsWideColumn">
          <jsp:include page="/jsp/blocks/admin/material_importgdocs.jsp">
            <jsp:param value="${parentFolderId}" name="parentFolderId"/>
          </jsp:include>
        </div>
