...
<html>
  ...
  <body class="environment index">
    ...
    <jsp:include page="/jsp/templates/index_header.jsp">
      <jsp:param name="activeTrail" value="materials"/>
    </jsp:include>
    ...
    <div class="GUI_pageWrapper">
		  ...
		  <div class="GUI_pageContainer">
		    ...
		    <div id="GUI_indexMaterialsListingPanel" class="pagePanel">
          <jsp:include page="/jsp/blocks/index/material_listing.jsp"></jsp:include>
	      </div>
	      
	      <div id="GUI_indexMaterialsContentPanel" class="pagePanel">
