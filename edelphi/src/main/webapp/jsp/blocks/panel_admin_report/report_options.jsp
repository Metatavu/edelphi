          ...
          <c:choose>
            <c:when test="${pageId gt 0}">
              <div class="modalPopupLinksContainer">
                ...
                <a href="${pageContext.request.contextPath}/queries/exportreportpage.binary?format=PDF&amp;serializedContext=${serializedContext}&amp;queryPageId=${pageId}&amp;stampId=${activeStamp.id}"
                  class="modalPopupLinkContainer exportPDF"><fmt:message key="panel.admin.report.options.downloadOrExportExportContentsPDF" /></a>
                <a href="${pageContext.request.contextPath}/queries/exportreportpage.binary?format=GOOGLE_DOCUMENT&amp;serializedContext=${serializedContext}&amp;queryPageId=${pageId}&amp;stampId=${activeStamp.id}"
                ...
                <a href="${pageContext.request.contextPath}/queries/exportreportpage.binary?format=PNG_ZIP&amp;serializedContext=${serializedContext}&amp;queryPageId=${pageId}&amp;stampId=${activeStamp.id}"
                  class="modalPopupLinkContainer exportPDF"><fmt:message key="panel.admin.report.options.downloadOrExportExportChartsPNG" /></a>
                <a href="${pageContext.request.contextPath}/queries/exportreportpage.binary?format=SVG_ZIP&amp;serializedContext=${serializedContext}&amp;queryPageId=${pageId}&amp;stampId=${activeStamp.id}"
                  class="modalPopupLinkContainer exportPDF"><fmt:message key="panel.admin.report.options.downloadOrExportExportChartsSVG" /></a>
                <a href="${pageContext.request.contextPath}/queries/exportreportpage.binary?format=GOOGLE_IMAGES&amp;serializedContext=${serializedContext}&amp;queryPageId=${pageId}&amp;stampId=${activeStamp.id}"
                  class="modalPopupLinkContainer exportGoogleDrive"
                ...
                <a href="${pageContext.request.contextPath}/queries/exportpagedata.binary?queryPageId=${pageId}&amp;serializedContext=${serializedContext}&amp;stampId=${activeStamp.id}&amp;format=CSV"
                  class="modalPopupLinkContainer exportCSV"><fmt:message key="panel.admin.report.options.downloadOrExportExportDataCSV" /></a>
                <a href="${pageContext.request.contextPath}/queries/exportpagedata.binary?queryPageId=${pageId}&amp;serializedContext=${serializedContext}&amp;stampId=${activeStamp.id}&amp;format=GOOGLE_SPREADSHEET"
            ...
            <c:otherwise>
              <div class="modalPopupLinksContainer">
                ...
                <h4><fmt:message key="panel.admin.report.options.downloadOrExportExportContentsTitle" /></h4>
                <a
                  href="${pageContext.request.contextPath}/queries/exportreport.binary?format=PDF&amp;serializedContext=${serializedContext}&amp;queryId=${queryId}&amp;stampId=${activeStamp.id}"
                  class="modalPopupLinkContainer exportPDF"><fmt:message key="panel.admin.report.options.downloadOrExportExportContentsPDF" /></a>
                <a
                  href="${pageContext.request.contextPath}/queries/exportreport.binary?format=GOOGLE_DOCUMENT&amp;serializedContext=${serializedContext}&amp;queryId=${queryId}&amp;stampId=${activeStamp.id}"
                  class="modalPopupLinkContainer exportGoogleDrive"
                  target="_blank"><fmt:message key="panel.admin.report.options.downloadOrExportExportContentsGoogleDocument" /></a>
                </div>
                <div class="modalPopupLinksContainerBlock">
                <h4><fmt:message key="panel.admin.report.options.downloadOrExportExportChartsTitle" /></h4>
                <a
                  href="${pageContext.request.contextPath}/queries/exportreport.binary?format=PNG_ZIP&amp;serializedContext=${serializedContext}&amp;queryId=${queryId}&amp;stampId=${activeStamp.id}"
                  class="modalPopupLinkContainer exportPDF"><fmt:message key="panel.admin.report.options.downloadOrExportExportChartsPNG" /></a>
                <a
                  href="${pageContext.request.contextPath}/queries/exportreport.binary?format=SVG_ZIP&amp;serializedContext=${serializedContext}&amp;queryId=${queryId}&amp;stampId=${activeStamp.id}"
                  class="modalPopupLinkContainer exportPDF"><fmt:message key="panel.admin.report.options.downloadOrExportExportChartsSVG" /></a>
                <a
                  href="${pageContext.request.contextPath}/queries/exportreport.binary?format=GOOGLE_IMAGES&amp;serializedContext=${serializedContext}&amp;queryId=${queryId}&amp;stampId=${activeStamp.id}"
                  class="modalPopupLinkContainer exportGoogleDrive"
                  target="_blank"><fmt:message key="panel.admin.report.options.downloadOrExportExportChartsGoogle" /></a>
                </div>
                <div class="modalPopupLinksContainerBlock">
                ...
                <div class="modalPopupLinksContainerBlock">
                  ...
                  <a href="${pageContext.request.contextPath}/queries/exportcomments.binary?panelId=${panelId}&amp;serializedContext=${serializedContext}&amp;queryId=${queryId}&amp;stampId=${activeStamp.id}&amp;format=CSV" class="modalPopupLinkContainer exportCSV">
                    <fmt:message key="panel.admin.report.options.downloadOrExportExportDataCSV" />
                  </a>
                </div>
              </div>
            </c:otherwise>
