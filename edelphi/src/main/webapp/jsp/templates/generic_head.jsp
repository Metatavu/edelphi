...
<link rel="icon" type="image/png" href="${themeUrl}/gfx/edelfoi.png"/>    
...
<link href="${themeUrl}/css/theme.css" rel="stylesheet"/>
...
<c:if test="${hasUnreadImportantBulletins}">
  ...
  <link href="${themeUrl}/css/important-bulletins.css" rel="stylesheet"/>
</c:if>
