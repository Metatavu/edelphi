package fi.metatavu.edelphi.i18n;
...
/**
 * REST locale strings controller
 * 
 * @author Antti Leppä
 */
@ApplicationScoped
public class RestMessages {
  ...
  private ResourceBundle getResourceBundle(Locale locale) {
    if (!bundles.containsKey(locale)) {
      ResourceBundle localeBundle = ResourceBundle.getBundle("fi.metatavu.edelphi.rest.i18n.restlocale", locale); 
