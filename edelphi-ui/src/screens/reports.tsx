...
import { User, Panel, Query, QueryPage, ReportType, ReportFormat, QueriesApi, UsersApi, PanelsApi, ReportsApi } from "../generated/client";
...
class Reports extends React.Component<Props, State> {
   ...
   * @returns reports API
   */
  private getReportsService(): ReportsApi {
