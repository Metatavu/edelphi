...
import { QueryQuestionCommentCategory, QueryQuestionCommentsApi } from "../../generated/client";
...
class QueryCommentEditor extends React.Component<Props, State> {
  ...
  private async loadComment() {
    ...
    const comments = await queryQuestionCommentsService.listQueryQuestionComments({
