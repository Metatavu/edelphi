...
class QueryComments extends React.Component<Props, State> {
  ...
  private loadData = async () => {
    ...
    const pageCategories = await queryQuestionCommentCategoriesService.listQueryQuestionCommentCategories({
      panelId: this.props.panelId,
      pageId: this.props.pageId,
      queryId: this.props.queryId
    });

    const queryCategories = await queryQuestionCommentCategoriesService.listQueryQuestionCommentCategories({
      panelId: this.props.panelId,
      queryId: this.props.queryId
    });
