...
import { QueryQuestionComment, QueryQuestionCommentCategory, QueryQuestionCommentsApi } from "../../generated/client";
...
class QueryCommentClass extends React.Component<Props, State> {
  ...
  private formatDateTime(dateTime?: Date | string) {
    return moment.default(dateTime).locale(this.props.locale).format("LLL"); 
  }
...
function mapStateToProps(state: StoreState) {
  return {
    ...
    logggedUserId: state.accessToken ? state.accessToken.userId : undefined,
    locale: state.locale
  };
}
