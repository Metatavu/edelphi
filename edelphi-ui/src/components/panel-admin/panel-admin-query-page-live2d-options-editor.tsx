...
import { QueryPageLive2DAnswersVisibleOption, QueryPagesApi } from "../../generated/client";
...
class PanelAdminQueryPageLive2dOptionsEditor extends React.Component<Props, State> {
  ...
  private loadData = async () => {
    ...
    const queryPage = await queryPagesService.findQueryPageLive2d({
    ...
    this.setState({
      loading: false,
      visible: queryPage.answersVisible || QueryPageLive2DAnswersVisibleOption.IMMEDIATELY
    });
  }
   ...
   * @returns query pages API
   */
  private getQueryPagesService(accessToken: string): QueryPagesApi {
  ...
  private onSaveClick = async () => {
    ...
    await queryPagesService.updateQueryPageLive2d({
      panelId: this.props.panelId,
      queryPageId: this.props.pageId,
      queryPageLive2d: {
        ... queryPage,
        answersVisible: this.state.visible
      }      
    });
