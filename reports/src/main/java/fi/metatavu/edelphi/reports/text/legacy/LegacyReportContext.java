...
/**
 * Legacy report context object
 * 
 * @author Antti Leppä
 */
public class LegacyReportContext implements Serializable {
  ...
  public LegacyReportContext() {
    // Zero-arg constructor
  }

  public LegacyReportContext(String locale, Long panelStampId) {
    this(locale, null, panelStampId);
  }

  public LegacyReportContext(String locale, Map<String, String> parameters, Long panelStampId) {
    this.locale = locale;
    if (parameters != null)
